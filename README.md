<div align="center">
  <img src="documentation/img/illuOGF.jpg" alt="Old Growth Forest" width="400">
...
├── OGF_plots_processing.R		-> script module to compute dendrometric variables from raw measurements  
    ...
    └── workflowOGF_preCarto.txt  -> workflow for generating a map of potential Old Growth Forest


## Methodology

<div align="center">
  <img src="documentation/img/plaConcentrique.png" alt="Circular plots and line intersect transect" width="400">
